  ...
  def default_attributes(travel_book)
    {
      ...
      memo: schedule.memo,
      start_date: schedule.start_date || travel_book&.start_date&.to_datetime&.change(hour: 12),
      end_date: schedule.end_date || travel_book&.start_date&.to_datetime&.change(hour: 12),
      name: spot.name,
